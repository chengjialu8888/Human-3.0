...
HUMAN 3.0 原始设定最打动人的地方，在于它承诺的是大多数自助工具给不了的东西：
...
原始 HUMAN 3.0 框架里最有力量的一点，是它认为大多数人都在解决错误的问题。这个 skill 的目标之一，就是帮你找出“下一个核心问题”是什么，因为一旦它被解决，其他领域会出现连锁式改善。
